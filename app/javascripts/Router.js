define(['Utils', 'Question', 'LocalStorage', 'Statistics' ] ,
    function(Utils, Question, LocalStorage, Statistics){
        "use strict"
        ...
        function Router() {
            ...
            this.objQuestion = Question;
            this.objParseModule = LocalStorage;
            this.objStatistics = Statistics;
        }

        Router.prototype.setQuizData = function(quizData){
